...
$Solution = Join-Path -Path $RepositoryRootPath -ChildPath 'demo' -AdditionalChildPath 'F0.Talks.ContinuousIntegration.sln'
$TestProject = Join-Path -Path $RepositoryRootPath -ChildPath 'demo' -AdditionalChildPath 'F0.Talks.ContinuousIntegration.Tests', 'F0.Talks.ContinuousIntegration.Tests.csproj'
